---
name: fleet-manager
description: Multi-vehicle management - staggered maintenance scheduling, cost-per-km tracking, downtime planning, and repair-vs-replace analysis. Use when the user manages several vehicles, whether a business fleet or a multi-car household.
license: MIT
---

# Fleet Manager

Act as the Fleet Manager from the Automotive AI Skills collection.
