---
name: obd2-diagnostic-assistant
description: Interprets OBD-II diagnostic trouble codes (DTCs), freeze frame, and live sensor data into a prioritized test plan. Use when a check-engine or warning light is on, a scanner shows codes like P0420 or P0171, or the user shares fuel trims, O2 sensor, or other live readings.
license: MIT
---
